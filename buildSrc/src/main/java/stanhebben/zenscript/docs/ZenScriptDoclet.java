...
public class ZenScriptDoclet extends Standard {
    ...
    public static boolean start(RootDoc root) {
        ...
        for(ZenClassDoc doc : classesByName.values()) {
            try {
                ...
                if(!outputDocParent.exists())
                    outputDocParent.mkdirs();
                ...
                if(doc.getDoc().isInterface() && doc.getDoc().methods().length == 1) {
                    ...
                    for(MethodDoc method : doc.getDoc().methods()) {
                        for(AnnotationDesc annotation : method.annotations()) {
                            ...
                            if(fullName.equals("stanhebben.zenscript.annotations.ZenMethod") || fullName.equals("stanhebben.zenscript.annotations.ZenMethodStatic")) {
                                String name = annotation.elementValues().length > 0 ? (String) (annotation.elementValues()[0].value().value()) : "";
                    ...
                    if(!staticProperties.isEmpty()) {
                        ...
                        for(String name : names) {
                            ...
                            if(!property.isCanSet())
                                writer.append("<span class=\"fa fa-lock\" style=\"color: #ccc;\" title=\"cannot be set\"></span> ");
                            writer.append("<a href=\"#property-staticvalue\">").append(property.getName()).append("</a></div>");
                            if(property.getComment() != null && property.getComment().length > 0) {
                                writer.append("<div class=\"property-intro\">").append(property.getComment()[0]).append("</div>");
                            }
                            writer.append("</td></tr>");
                        }
                    ...
                    if(!staticMethods.isEmpty()) {
                        ...
                        for(ZenMethodDoc method : staticMethods) {
                            ...
                            writer.append("<td>");
                            writer.append("<div class=\"property-name\">");
                            writer.append("<a href=\"#property-staticvalue\">").append(method.getName()).append("</a>(");
                            boolean first = true;
                            
                            for(ZenParameterDoc param : method.getParameters()) {
                                if(param.isOptional())
                                    writer.append("<span class=\"param-optional\">");
                                if(first) {
                                    first = false;
                                } else {
                                    writer.append(", ");
                            ...
                            if(comment.length > 0) {
                                writer.append("<div class=\"property-intro\">").append(comment[0]).append("</div>");
                            }
                            writer.append("</td></tr>");
                        }
    ...
    private static String buildPackageList(List<ZenClassDoc> classes, String baseurl) {
        ...
        for(int i = 0; i < packageSorted.length; i++) {
            ...
            output.append("<a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse-").append(pkgId).append("\"><span class=\"glyphicon glyphicon-th-large\"></span> ").append(packageSorted[i]).append("</a>");
            output.append("</h4></div>");
            
            output.append("<div id=\"collapse-").append(pkgId).append("\" class=\"panel-collapse collapse\">");
            ...
            if(!interfaceNames.isEmpty()) {
                ...
                for(String ifaceName : interfaceNames) {
                    output.append("<tr><td><a href=\"").append(pkgDir).append('/').append(ifaceName).append(".html").append("\">").append(ifaceName).append("</a></td></tr>");
                }
            ...
            if(!classNames.isEmpty()) {
                ...
                for(String className : classNames) {
                    output.append("<tr><td><a href=\"").append(pkgDir).append('/').append(className).append(".html").append("\">").append(className).append("</a></td></tr>");
                }
