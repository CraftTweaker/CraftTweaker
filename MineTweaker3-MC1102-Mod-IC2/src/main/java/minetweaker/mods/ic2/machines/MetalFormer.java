...
public class MetalFormer {
    ...
    public static void addExtrudingRecipe(IItemStack output, IIngredient input) {
        MineTweakerAPI.apply(new MachineAddRecipeAction("metal former - extruding", Recipes.metalformerExtruding, getItemStacks(output), null, new IC2RecipeInput(input)));
    }
    ...
    public static void addRollingRecipe(IItemStack output, IIngredient input) {
        MineTweakerAPI.apply(new MachineAddRecipeAction("metal former - rolling", Recipes.metalformerRolling, getItemStacks(output), null, new IC2RecipeInput(input)));
    }
    ...
    public static void addCuttingRecipe(IItemStack output, IIngredient input) {
        MineTweakerAPI.apply(new MachineAddRecipeAction("metal former - cutting", Recipes.metalformerCutting, getItemStacks(output), null, new IC2RecipeInput(input)));
    }
