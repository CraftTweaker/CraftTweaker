package minetweaker.mc1120.furnace;
...
public class MCFurnaceManager implements IFurnaceManager {
    ...
    private static class RemoveAction implements IUndoableAction {
        ...
        public void undo() {
            for(int i = 0; i < items.size(); i++) {
                ...
                MineTweakerAPI.getIjeiRecipeRegistry().addFurnace(Arrays.asList(items.toArray()), values.get(i));
            }
    ...
    private static class AddRecipeAction implements IUndoableAction {
        ...
        public void apply() {
            ...
            MineTweakerAPI.getIjeiRecipeRegistry().addFurnace(Arrays.asList(input), output);
        }
