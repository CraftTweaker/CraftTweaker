...
public class GuiCannotRemodify extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120 + 12, "Close"));
    }

    @Override
    public void drawScreen(int par1, int par2, float par3) {
        this.drawDefaultBackground();
        this.drawCenteredString(this.fontRenderer, message1, this.width / 2, this.height / 2 - 40, 11184810);
        this.drawCenteredString(this.fontRenderer, message2, this.width / 2, this.height / 2 - 20, 11184810);
        this.drawCenteredString(this.fontRenderer, message3, this.width / 2, this.height / 2, 11184810);
