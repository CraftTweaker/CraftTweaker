...
public abstract class DocumentationPage implements IFillMeta<DocumentMeta> {
    ...
    public void writeMeta(PageOutputWriter writer, Gson gson) {
        ...
        meta.setDescription(pageInfo.getClassComment().getOptionalDescription().orElse(""));
        fillMeta(meta);
        MemberMeta memberMeta = new MemberMeta();
        virtualMembers.fillMeta(memberMeta);
        staticMembers.fillMeta(memberMeta);
        meta.setMembers(memberMeta);
