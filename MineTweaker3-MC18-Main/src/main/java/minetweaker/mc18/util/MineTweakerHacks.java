...
public class MineTweakerHacks{
    ...
    static{
        ...
        SHAPEDORERECIPE_WIDTH = getField(ShapedOreRecipe.class, "width");
    ...
    public static Map getTranslations(){
        return getPrivateObject(getPrivateStaticObject(StatCollector.class, "localizedName", "field_74839_a"), "languageList", "field_74816_c");
    }
