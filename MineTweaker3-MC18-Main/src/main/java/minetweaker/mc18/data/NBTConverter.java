...
public class NBTConverter implements IDataConverter<NBTBase>{
    ...
    public static IData from(NBTBase nbt, boolean immutable){
        ...
        switch(nbt.getId()){
            case 1: // byte
                return new DataByte(((NBTBase.NBTPrimitive) nbt).getByte());
            case 2: // short
                return new DataShort(((NBTBase.NBTPrimitive) nbt).getShort());
            case 3: // int
                return new DataInt(((NBTBase.NBTPrimitive) nbt).getInt());
            case 4: // long
                return new DataLong(((NBTBase.NBTPrimitive) nbt).getLong());
            case 5: // float
                return new DataFloat(((NBTBase.NBTPrimitive) nbt).getFloat());
            case 6: // double
                return new DataDouble(((NBTBase.NBTPrimitive) nbt).getDouble());
            case 7: // byte[]
