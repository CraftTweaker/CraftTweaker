...
@NativeTypeRegistration(value = MerchantOffer.class, zenCodeName = "crafttweaker.api.villager.MerchantOffer",
        constructors = {
                @NativeConstructor({
                        ...
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "uses"),
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "maxUses"),
                }),
                @NativeConstructor({
                        @NativeConstructor.ConstructorParameter(type = ItemStack.class, name = "baseCostA"),
                        ...
                        @NativeConstructor.ConstructorParameter(type = ItemStack.class, name = "result"),
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "maxUses"),
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "xp"),
                ...
                @NativeConstructor({
                        ...
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "xp"),
                        @NativeConstructor.ConstructorParameter(type = Float.class, name = "priceMultiplier"),
                        @NativeConstructor.ConstructorParameter(type = Integer.class, name = "demand"),
                })
        })
