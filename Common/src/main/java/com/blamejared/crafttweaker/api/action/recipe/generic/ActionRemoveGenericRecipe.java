...
public class ActionRemoveGenericRecipe extends ActionRemoveGenericRecipeBase {
    ...
    protected final Predicate<RecipeHolder<Recipe<Container>>> removePredicate;
    protected Supplier<String> describeFunction;
    
    public ActionRemoveGenericRecipe(Predicate<RecipeHolder<Recipe<Container>>> removePredicate) {
        
        this.removePredicate = removePredicate;
        this.describeFunction = () -> "Removing all recipes that match a custom condition";
    }
    
    public ActionRemoveGenericRecipe(Predicate<RecipeHolder<Recipe<Container>>> removePredicate, Supplier<String> describeFunction) {
