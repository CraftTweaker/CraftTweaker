...
public class ActionReplaceRecipeOld<T extends Recipe<?>> extends ActionRecipeBase<T> {
    ...
    public ActionReplaceRecipeOld(final IRecipeManager<T> manager, final Function<ResourceLocation, ResourceLocation> nameGenerator,
