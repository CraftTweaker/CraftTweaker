...
public class IngredientListTest implements CraftTweakerGameTest {
    ...
    public void testTest(GameTestHelper helper, Arguments arguments) {
        ...
        List<Ingredient> ingredients = List.of(Ingredient.of(Items.APPLE), IngredientList.ingredient(List.of(Ingredient.of(Items.BARREL))));
        CraftTweakerVanillaIngredient subject = IngredientList.of(ingredients);
    ...
    public static Stream<Arguments.Builder> testTestArguments() {
        ...
        return Stream.of(
                Arguments.Builder.named("item passes")
                        ...
                        .expected(true),
                Arguments.Builder.named("nested item passes")
                        .input(Items.BARREL.getDefaultInstance())
                        .expected(true),
