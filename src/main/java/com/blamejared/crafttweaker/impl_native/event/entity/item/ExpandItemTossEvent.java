...
@EventCancelable(canceledDescription = "will stop the items from entering the world, but will not prevent them being removed from the inventory - and thus removed from the system.")
