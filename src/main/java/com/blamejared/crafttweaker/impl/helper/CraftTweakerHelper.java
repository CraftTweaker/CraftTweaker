...
public class CraftTweakerHelper {
    ...
    public static Item[] getItemsFromDefinitions(List<MCItemDefinition> definitions) {
        return definitions.stream().map(MCItemDefinition::getInternal).toArray(Item[]::new);
    }
