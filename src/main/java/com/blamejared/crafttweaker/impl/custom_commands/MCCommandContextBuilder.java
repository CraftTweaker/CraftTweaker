...
@ZenRegister
@ZenCodeType.Name("crafttweaker.api.custom_commands.MCCommandContextBuilder")
public class MCCommandContextBuilder {
    ...
    public MCCommandContextBuilder withArgument(final String name, final MCParsedArgument argument) {
        final CommandContextBuilder<CommandSource> builder = internal.withArgument(name, argument
                .getInternal());
        return this.internal == builder ? this : new MCCommandContextBuilder(builder);
    }
    ...
    public Map<String, MCParsedArgument> getArguments() {
        return internal.getArguments().entrySet().stream()
    ...
    public MCCommandContextBuilder withCommand(final MCCommand command) {
        final CommandContextBuilder<CommandSource> builder = this.internal.withCommand(command
                .getInternal());
        return this.internal == builder ? this : new MCCommandContextBuilder(builder);
    }
    ...
    public MCCommandContextBuilder withNode(final MCCommandNode node, final MCStringRange range) {
        final CommandContextBuilder<CommandSource> bui = internal.withNode(node.getInternal(), range
                .getInternal());
    ...
    public List<MCParsedCommandNode> getNodes() {
        return internal.getNodes().stream()
                .map(MCParsedCommandNode::new)
