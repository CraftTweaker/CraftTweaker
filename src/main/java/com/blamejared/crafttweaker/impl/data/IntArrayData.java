...
public class IntArrayData implements ICollectionData {
    ...
    public IntData set(int index, IData value) {
        if(value instanceof NumberNBT) {
            return new IntData(internal.set(index, IntNBT.func_229692_a_(((INumberData) value).getInt())));
        } else {
            return null;
        }
    }
    ...
    public void add(int index, IData value) {
        if(value instanceof INumberData) {
            internal.add(index, IntNBT.func_229692_a_(((INumberData) value).getInt()));
        }
    }
    ...
    public void add(IData value) {
        if(value instanceof INumberData) {
            internal.add(IntNBT.func_229692_a_(((INumberData) value).getInt()));
        }
    }
