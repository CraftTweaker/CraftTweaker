...
public final class ModifierBlockExpansion {
    ...
    /**
     * Adds an {@link ILootModifier} to the current block, only if it is not harvested with the silk touch enchantment.
     *
     * @param internal The block to add the drops to.
