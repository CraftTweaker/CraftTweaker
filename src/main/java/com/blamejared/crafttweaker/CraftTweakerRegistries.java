...
public class CraftTweakerRegistries {
    ...
    public static void init() {
        ...
        REGISTRY_TRANSFORMER_SERIALIZER = (SimpleRegistry<IIngredientTransformerSerializer<?>>) registry.register(RegistryKey.getOrCreateRootKey(transformerSerializerRL), new SimpleRegistry<>(RegistryKey.getOrCreateRootKey(transformerSerializerRL), Lifecycle.stable()), Lifecycle.stable());
        REGISTRY_CONDITIONER_SERIALIZER = (SimpleRegistry<IIngredientConditionSerializer<?>>) registry.register(RegistryKey.getOrCreateRootKey(conditionSerializerRL), new SimpleRegistry<>(RegistryKey.getOrCreateRootKey(conditionSerializerRL), Lifecycle.stable()), Lifecycle.stable());
        ...
        REGISTRY_TRANSFORMER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_TRANSFORMER_SERIALIZER.getRegistryKey(), TRANSFORM_DAMAGE_SERIALIZER.getType()), TRANSFORM_DAMAGE_SERIALIZER, Lifecycle.stable());
        
        TRANSFORM_CUSTOM_SERIALIZER = new TransformCustom.TransformCustomSerializer();
        REGISTRY_TRANSFORMER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_TRANSFORMER_SERIALIZER.getRegistryKey(), TRANSFORM_CUSTOM_SERIALIZER.getType()), TRANSFORM_CUSTOM_SERIALIZER, Lifecycle.stable());
        
        TRANSFORM_REUSE_SERIALIZER = new TransformReuse.TransformerReuseSerializer();
        REGISTRY_TRANSFORMER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_TRANSFORMER_SERIALIZER.getRegistryKey(), TRANSFORM_REUSE_SERIALIZER.getType()), TRANSFORM_REUSE_SERIALIZER, Lifecycle.stable());
        
        
        CONDITION_DAMAGE_SERIALIZER = new ConditionDamaged.ConditionDamagedSerializer();
        REGISTRY_CONDITIONER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_CONDITIONER_SERIALIZER.getRegistryKey(), CONDITION_DAMAGE_SERIALIZER.getType()), CONDITION_DAMAGE_SERIALIZER, Lifecycle.stable());
        
        CONDITION_ANY_DAMAGE_SERIALIZER = new ConditionAnyDamage.ConditionAnyDamagedSerializer();
        REGISTRY_CONDITIONER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_CONDITIONER_SERIALIZER.getRegistryKey(), CONDITION_ANY_DAMAGE_SERIALIZER.getType()), CONDITION_ANY_DAMAGE_SERIALIZER, Lifecycle.stable());
        
        CONDITION_CUSTOM_SERIALIZER = new ConditionCustom.ConditionCustomSerializer();
        REGISTRY_CONDITIONER_SERIALIZER.register(RegistryKey.getOrCreateKey(REGISTRY_CONDITIONER_SERIALIZER.getRegistryKey(), CONDITION_CUSTOM_SERIALIZER.getType()), CONDITION_CUSTOM_SERIALIZER, Lifecycle.stable());
    }
}
