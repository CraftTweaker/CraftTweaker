...
public class CraftTweakerRegistries {
    ...
    public static void init() {
        ResourceLocation location = new ResourceLocation(CraftTweaker.MODID, "transformer_serializer");
        MutableRegistry registry = (MutableRegistry) Registry.REGISTRY;
        REGISTRY_TRANSFORMER_SERIALIZER = (SimpleRegistry<IIngredientTransformerSerializer<?>>) registry.register(RegistryKey.func_240904_a_(location), new SimpleRegistry<>(RegistryKey.func_240904_a_(location), Lifecycle.stable()));
