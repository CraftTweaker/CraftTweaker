...
public class ZenTypeFloat extends ZenType {
	...
	// private static final JavaMethod FLOAT_TOSTRING =
	// JavaMethod.get(EMPTY_REGISTRY, Float.class, "toString", float.class);
	 ...
	 * 
	 * if (type == BYTE) { output.f2i(); output.i2b(); } else if (type ==
	 * ZenTypeByteObject.INSTANCE) { output.f2i(); output.i2b();
	 * output.invokeStatic(Byte.class, "valueOf", Byte.class, byte.class); }
	 * else if (type == SHORT) { output.f2i(); output.i2s(); } else if (type ==
	 * ZenTypeShortObject.INSTANCE) { output.f2i(); output.i2s();
	 * output.invokeStatic(Short.class, "valueOf", Short.class, short.class); }
	 * else if (type == INT) { output.f2i(); } else if (type ==
	 * ZenTypeIntObject.INSTANCE) { output.f2i();
	 * output.invokeStatic(Integer.class, "valueOf", Integer.class, int.class);
	 * } else if (type == LONG) { output.f2l(); } else if (type ==
	 * ZenTypeLongObject.INSTANCE) { output.f2l();
	 * output.invokeStatic(Long.class, "valueOf", Long.class, long.class); }
	 * else if (type == FLOAT) { // nothing to do } else if (type ==
	 * ZenTypeFloatObject.INSTANCE) { output.invokeStatic(Float.class,
	 * "valueOf", Float.class, float.class); } else if (type == DOUBLE) {
	 * output.f2d(); } else if (type == ZenTypeDoubleObject.INSTANCE) {
	 * output.f2d(); output.invokeStatic(Double.class, "valueOf", Double.class,
	 * double.class); } else if (type == STRING) {
	 * output.invokeStatic(Float.class, "toString", String.class, float.class);
	 * } else if (type == ANY) {
	 * output.invokeStatic(getAnyClassName(environment), "valueOf", "(F)" +
