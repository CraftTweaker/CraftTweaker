...
@NativeTypeRegistration(value = VillagerTrades.ItemsAndEmeraldsToItems.class, zenCodeName = "crafttweaker.api.villager.trade.type.ItemsAndEmeraldsToItems",
        constructors = {
                @NativeConstructor({
                        @NativeConstructor.ConstructorParameter(type = ItemLike.class, name = "fromItem", description = "The secondary item that is being given to the villager", examples = "<item:minecraft:dirt>"),
                        @NativeConstructor.ConstructorParameter(type = int.class, name = "fromCount", description = "The amount of the secondary item that is being given to the villager", examples = "4"),
