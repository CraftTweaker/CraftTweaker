...
public class ExpandEntityTypeTag {
    ...
    public static Many<KnownTag<EntityType<Entity>>> asManyTag(KnownTag<EntityType<Entity>> internal) {
        
        return internal.asTagWithAmount();
    }
    
    @ZenCodeType.Method
    @ZenCodeType.Caster(implicit = true)
    public static CTEntityIngredient asEntityIngredient(KnownTag<EntityType<Entity>> internal) {
        
        return new CTEntityIngredient.EntityTagWithAmountIngredient(GenericUtil.uncheck(internal.withAmount(1)));
    }
    
    @ZenCodeType.Method
    @ZenCodeType.Operator(ZenCodeType.OperatorType.OR)
    public static CTEntityIngredient asList(KnownTag<EntityType<Entity>> internal, CTEntityIngredient other) {
