        ...
        if (i >= 0 && getSlot(i) != null && getSlot(i) instanceof SlotRecipe) // Fake slots
        {
            if (mousebtn == 2) {
                ...
                if (!stackHeld.isEmpty() ) {
                    ...
                    if (!(getSlot(i) instanceof SlotRecipeOutput)) newStack.setCount(1);;
                ...
                if (!stackHeld.isEmpty() ) {
                    ...
                    if (!stackSlot.isEmpty() && stackHeld.isItemEqual(stackSlot) && i == 0) {
                        ...
                        if (stackSlot.getCount() > max) stackSlot.setCount(max);
                    ...
                    if (!stackSlot.isEmpty() ) {
                        stackSlot.setCount(stackSlot.getCount()-1);
                        if (stackSlot.getCount() == 0) getSlot(i).putStack(ItemStack.EMPTY);
                    }
                }
            }
        } else {
