...
@ZenRegister
@ZenEvent
@Document("forge/api/event/entity/player/PlayerBreakSpeedEvent")
@NativeTypeRegistration(value = PlayerEvent.BreakSpeed.class, zenCodeName = "crafttweaker.forge.api.event.entity.player.PlayerBreakSpeedEvent")
