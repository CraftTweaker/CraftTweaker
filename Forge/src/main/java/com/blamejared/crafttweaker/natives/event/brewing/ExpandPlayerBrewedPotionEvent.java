...
@ZenRegister
@ZenEvent
@Document("forge/api/event/brewing/PlayerBrewedPotionEvent")
@NativeTypeRegistration(value = PlayerBrewedPotionEvent.class, zenCodeName = "crafttweaker.forge.api.event.brewing.PlayerBrewedPotionEvent")
