...
@ZenRegister
@ZenEvent
@Document("forge/api/event/entity/player/PlayerCloneEvent")
@NativeTypeRegistration(value = PlayerEvent.Clone.class, zenCodeName = "crafttweaker.forge.api.event.entity.player.PlayerCloneEvent")
