...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/entity/player/SleepingTimeCheckEvent")
@NativeTypeRegistration(value = SleepingTimeCheckEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.player.SleepingTimeCheckEvent")
