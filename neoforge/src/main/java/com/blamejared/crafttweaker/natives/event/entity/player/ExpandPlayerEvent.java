...
@ZenRegister
@Document("neoforge/api/event/entity/player/PlayerEvent")
@NativeTypeRegistration(value = PlayerEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.player.PlayerEvent")
