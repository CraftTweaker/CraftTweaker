...
@ZenRegister
@Document("neoforge/api/event/entity/teleport/EntityTeleportEvent")
@NativeTypeRegistration(value = EntityTeleportEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.teleport.EntityTeleportEvent")
