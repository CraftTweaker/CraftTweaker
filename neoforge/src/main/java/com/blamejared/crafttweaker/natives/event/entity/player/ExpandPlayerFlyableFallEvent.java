...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/entity/player/PlayerFlyableFallEvent")
@NativeTypeRegistration(value = PlayerFlyableFallEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.player.PlayerFlyableFallEvent")
