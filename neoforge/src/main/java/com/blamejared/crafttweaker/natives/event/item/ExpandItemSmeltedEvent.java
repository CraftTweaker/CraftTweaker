...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/item/ItemSmeltedEvent")
@NativeTypeRegistration(value = PlayerEvent.ItemSmeltedEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.item.ItemSmeltedEvent")
