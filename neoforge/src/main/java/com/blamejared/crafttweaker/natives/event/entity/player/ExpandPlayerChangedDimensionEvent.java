...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/entity/player/PlayerChangedDimensionEvent")
@NativeTypeRegistration(value = PlayerEvent.PlayerChangedDimensionEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.player.PlayerChangedDimensionEvent")
