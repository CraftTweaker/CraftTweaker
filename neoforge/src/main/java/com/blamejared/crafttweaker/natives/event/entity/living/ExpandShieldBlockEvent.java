...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/entity/living/ShieldBlockEvent")
@NativeTypeRegistration(value = ShieldBlockEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.living.ShieldBlockEvent")
