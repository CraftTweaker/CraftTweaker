...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/item/ItemTooltipEvent")
@NativeTypeRegistration(value = ItemTooltipEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.item.ItemTooltipEvent")
