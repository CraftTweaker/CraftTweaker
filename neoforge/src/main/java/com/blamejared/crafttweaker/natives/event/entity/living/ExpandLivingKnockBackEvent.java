...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/entity/living/LivingKnockBackEvent")
@NativeTypeRegistration(value = LivingKnockBackEvent.class, zenCodeName = "crafttweaker.neoforge.api.event.entity.living.LivingKnockBackEvent")
