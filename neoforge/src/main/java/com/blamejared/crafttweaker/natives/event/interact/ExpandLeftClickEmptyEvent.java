...
@ZenRegister
@ZenEvent
@Document("neoforge/api/event/interact/LeftClickEmptyEvent")
@NativeTypeRegistration(value = PlayerInteractEvent.LeftClickEmpty.class, zenCodeName = "crafttweaker.neoforge.api.event.interact.LeftClickEmptyEvent")
