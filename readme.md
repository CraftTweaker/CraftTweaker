...
[![GitHub license](https://img.shields.io/github/license/CraftTweaker/CraftTweaker?color=0690ff&style=flat-square)](https://github.com/CraftTweaker/CraftTweaker/blob/1.20/LICENSE)
[![Jenkins](https://img.shields.io/jenkins/build?jobUrl=https%3A%2F%2Fci.blamejared.com%2Fjob%2FJared%2Fjob%2FMinecraft%2520Mods%2Fjob%2FCraftTweaker%2Fjob%2F1.20%2F&style=flat-square)](https://ci.blamejared.com/job/Jared/job/Minecraft%20Mods/job/CraftTweaker/job/1.20/)
...
Distributed under the MIT License. See the [LICENSE](https://github.com/CraftTweaker/CraftTweaker/blob/1.20/LICENSE) file for more information.
...
### Fabric [![Maven](https://img.shields.io/maven-metadata/v?color=C71A36&label=Latest%20version&logo=Latest%20version&metadataUrl=https%3A%2F%2Fmaven.blamejared.com%2Fcom%2Fblamejared%2Fcrafttweaker%2FCraftTweaker-fabric-1.20%2Fmaven-metadata.xml&style=flat-square)](https://maven.blamejared.com/com/blamejared/crafttweaker/CraftTweaker-fabric-1.20/)

```groovy
dependencies {
    modCompileOnly('com.blamejared.crafttweaker:CraftTweaker-fabric-1.20:[VERSION]')
    // Example:
    // modCompileOnly('com.blamejared.crafttweaker:CraftTweaker-fabric-1.20:13.0.0')
}
```

### Forge [![Maven](https://img.shields.io/maven-metadata/v?color=C71A36&label=Latest%20version&logo=Latest%20version&metadataUrl=https%3A%2F%2Fmaven.blamejared.com%2Fcom%2Fblamejared%2Fcrafttweaker%2FCraftTweaker-forge-1.20%2Fmaven-metadata.xml&style=flat-square)](https://maven.blamejared.com/com/blamejared/crafttweaker/CraftTweaker-forge-1.20/)


```groovy
    compileOnly(fg.deobf('com.blamejared.crafttweaker:CraftTweaker-forge-1.20:[VERSION]'))
    // Example:
    // compileOnly(fg.deobf('com.blamejared.crafttweaker:CraftTweaker-forge-1.20:13.0.0'))
}
```

### Common [![Maven](https://img.shields.io/maven-metadata/v?color=C71A36&label=Latest%20version&logo=Latest%20version&metadataUrl=https%3A%2F%2Fmaven.blamejared.com%2Fcom%2Fblamejared%2Fcrafttweaker%2FCraftTweaker-common-1.20%2Fmaven-metadata.xml&style=flat-square)](https://maven.blamejared.com/com/blamejared/crafttweaker/CraftTweaker-common-1.20/)
...
```groovy
dependencies {
    compileOnly('com.blamejared.crafttweaker:CraftTweaker-common-1.20:[VERSION]')
    // Example:
    // compileOnly('com.blamejared.crafttweaker:CraftTweaker-common-1.20:13.0.0')
}
```
