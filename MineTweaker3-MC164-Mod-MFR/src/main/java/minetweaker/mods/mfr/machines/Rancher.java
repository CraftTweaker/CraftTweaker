...
public class Rancher {
	...
	private static class TweakerRanchable implements IFactoryRanchable {
		...
		public TweakerRanchable(Class<?> entityClass, WeightedItemStack[] possibleDrops, WeightedLiquidStack[] possibleLiquids) {
	...
	private static class AddRanchableAction implements IUndoableAction {
		...
		@Override
		public void apply() {
			FactoryRegistry.registerRanchable(ranchable);
		}
