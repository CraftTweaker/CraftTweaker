...
public class CraftTweakerEvents {
    ...
    public static final Event<Consumer<ICustomBepRegistrationEvent>> REGISTER_CUSTOM_BEP_EVENT =
            EventFactory.createArrayBacked(Consumer.class, listeners -> event -> Arrays.stream(listeners)
                    .forEach(handler -> handler.accept(event)));
