...
import minetweaker.mc11.actions.*;
import minetweaker.mc11.block.MCItemBlock;
import minetweaker.mc11.data.NBTConverter;
import minetweaker.mc11.liquid.MCLiquidStack;
...
//			throw new IllegalArgumentException("stack cannot be null");
	...
	public ILiquidStack getLiquid() {
		if(stack.getItem() instanceof ItemFluidContainer) {
			return new MCLiquidStack(stack.getCapability(CapabilityFluidHandler.FLUID_HANDLER_ITEM_CAPABILITY, null).getTankProperties()[0].getContents());
		}
	...
	public boolean equals(Object obj) {
		...
		return this.stack.getItem() == other.stack.getItem() && this.stack.getItemDamage() == other.stack.getItemDamage() && this.stack.getCount() == other.stack.getCount() && !(this.stack.getTagCompound() != other.stack.getTagCompound() && (this.stack == null || this.stack.equals(other.stack))) && this.wildcardSize == other.wildcardSize;
	}
