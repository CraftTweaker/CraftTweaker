...
package minetweaker.mc11.liquid;
...
public class MCLiquidDefinition implements ILiquidDefinition {
	...
	public List<IItemStack> getContainers() {
		...
		//			}
		//		}
		MineTweakerAPI.logError("getContainer not implemented in 1.11!");
		return result;
	}
	...
	private class AddContainerAction implements IUndoableAction {
		...
		@Override
		public void apply() {
			MineTweakerAPI.logError("AddContainer not implemented in 1.11!");
//			FluidContainerRegistry.registerFluidContainer(new FluidStack(fluid, amount), MineTweakerMC.getItemStack(filled), MineTweakerMC.getItemStack(empty));
		...
		public String describe() {
			return "Adding " + filled.getDisplayName() + " as liquid container for " + fluid.getLocalizedName(new FluidStack(fluid, 1000));
		}
