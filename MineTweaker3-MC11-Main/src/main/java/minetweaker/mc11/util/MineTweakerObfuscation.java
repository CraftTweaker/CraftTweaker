...
public class MineTweakerObfuscation{
    ...
    public static final String[] SLOTCRAFTING_PLAYER = {"player", "field_75238_b"};
    public static final String[] LANGUAGEMAP_INSTANCE = {"instance", "field_74817_a"};
